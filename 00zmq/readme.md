...
jupyter_console.zmqhistory.ZMQHistoryManager <- IPython.core.history.HistoryAccessorBase <- traitlets.config.configurable.LoggingConfigurable <- traitlets.config.configurable.Configurable <- traitlets.traitlets.HasTraits <- traitlets.traitlets.HasDescriptors <- builtins.object
    [method, OVERRIDE] __init__(self, client)
    [method] end_session(self)
    [method, OVERRIDE] get_range(self, session, start=1, stop=None, raw=True, output=False)
        [method] _load_history(self, raw=True, output=False, hist_access_type='range', **kwargs)
    [method, OVERRIDE] get_range_by_str(self, rangestr, raw=True, output=False)
        [method] _load_history(self, raw=True, output=False, hist_access_type='range', **kwargs)
    [method, OVERRIDE] get_tail(self, n=10, raw=True, output=False, include_latest=False)
        [method] _load_history(self, raw=True, output=False, hist_access_type='range', **kwargs)
    [method] reset(self, new_session=True)
    [method, OVERRIDE] search(self, pattern='*', raw=True, search_raw=True, output=False, n=None, unique=False)
        [method] _load_history(self, raw=True, output=False, hist_access_type='range', **kwargs)
...
IPython.core.history.HistoryAccessorBase <- traitlets.config.configurable.LoggingConfigurable <- traitlets.config.configurable.Configurable <- traitlets.traitlets.HasTraits <- traitlets.traitlets.HasDescriptors <- builtins.object
    [method] get_range(self, session, start=1, stop=None, raw=True, output=False)
    [method] get_range_by_str(self, rangestr, raw=True, output=False)
    [method] get_tail(self, n=10, raw=True, output=False, include_latest=False)
    [method] search(self, pattern='*', raw=True, search_raw=True, output=False, n=None, unique=False)
...
```console
$ pyinspect inspect jupyter_console.ptshell:ZMQTerminalInteractiveShell
jupyter_console.ptshell.ZMQTerminalInteractiveShell <- traitlets.config.configurable.SingletonConfigurable <- traitlets.config.configurable.LoggingConfigurable <- traitlets.config.configurable.Configurable <- traitlets.traitlets.HasTraits <- traitlets.traitlets.HasDescriptors <- builtins.object
    [method, OVERRIDE] __init__(self, **kwargs)
        [method] init_history(self)
        [method] init_completer(self)
        [method] init_io(self)
        [method] init_kernel_info(self)
        [method] init_prompt_toolkit_cli(self)
            [method] prompt_for_code(self)
                [method] pre_prompt(self)
            [method] print_out_prompt(self)
                [method] get_out_prompt_tokens(self)
            [method] handle_iopub(self, msg_id='')
                [method] include_output(self, msg)
                    [method] from_here(self, msg)
                [method] handle_rich_data(self, data)
                    [method] handle_image(self, data, mime)
                [method] print_out_prompt(self)
                    [method] get_out_prompt_tokens(self)
                [method] from_here(self, msg)
            [method] check_complete(self, code)
                [method] handle_is_complete_reply(self, msg_id, timeout=None)
            [method] get_prompt_tokens(self, cli)
            [method] get_continuation_tokens(self, cli, width)
    [method] _banner1_default(self)
    [method] _client_changed(self, name, old, new)
    [method] handle_image_PIL(self, data, mime)
    [method] handle_image_callable(self, data, mime)
    [method] handle_image_stream(self, data, mime)
    [method] handle_image_tempfile(self, data, mime)
    [method] mainloop(self)
        [method] interact(self, display_banner=None)
            [method] prompt_for_code(self)
                [method] pre_prompt(self)
            [method] run_cell(self, cell, store_history=True)
                [method] handle_iopub(self, msg_id='')
                    [method] include_output(self, msg)
                        [method] from_here(self, msg)
                    [method] handle_rich_data(self, data)
                    ...
                    [method] print_out_prompt(self)
                        [method] get_out_prompt_tokens(self)
                    [method] from_here(self, msg)
                [method] handle_input_request(self, msg_id, timeout=0.1)
                    [method] handle_iopub(self, msg_id='')
                        [method] include_output(self, msg)
                            [method] from_here(self, msg)
                        [method] handle_rich_data(self, data)
                        ...
                        [method] print_out_prompt(self)
                            [method] get_out_prompt_tokens(self)
                        [method] from_here(self, msg)
                [method] handle_execute_reply(self, msg_id, timeout=None)
                    [method] handle_iopub(self, msg_id='')
                        [method] include_output(self, msg)
                            [method] from_here(self, msg)
                        [method] handle_rich_data(self, data)
                        ...
                        [method] print_out_prompt(self)
                            [method] get_out_prompt_tokens(self)
                        [method] from_here(self, msg)
                    [method] ask_exit(self)
            [method] ask_exit(self)
    [method] show_banner(self)
...
```console
$ pyinspect inspect jupyter_console.app:ZMQTerminalIPythonApp
...
```console
$ pyinspect inspect jupyter_console.completer:ZMQCompleter
jupyter_console.completer.ZMQCompleter <- traitlets.config.configurable.Configurable <- traitlets.traitlets.HasTraits <- traitlets.traitlets.HasDescriptors <- builtins.object
    [method, OVERRIDE] __init__(self, shell, client, config=None)
    [method] complete_request(self, code, cursor_pos)
